<%-- 
    Document   : login
    Created on : Mar 13, 2024, 5:08:12 PM
    Author     : hatro
--%>
                            ...
                            <div class="login-form">
                                <form action="authen?action=login" method="post">
                                    ...
                                    <div class="single-login">
                                        ...
                                        <input value="${usernameLogin}"  type="text" name="username"  />
                                    </div>
                                    
                                    <div class="single-login">
                                        <label>Passwords <span>*</span></label>
                                        <input type="password" name="password" value="${passwordLogin}"/>
                                    </div>
                                    ...
                                    <div>
                                        <spam style="color:red">${error2}</spam>
                                    </div>
