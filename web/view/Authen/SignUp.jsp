<%-- 
    Document   : SignUp
    Created on : Mar 18, 2024, 9:38:37 PM
    Author     : hatro
--%>
                    ...
                    <div class="row">
                        ...
                        <div class="offset-lg-2 col-lg-8 col-md-12 col-12">
                            <div class="billing-fields">
                                <div class="single-register">
                                    <form action="authen?action=sign-up" method="POST" id="signUpForm">
                                        ...
                                        <input type="text" placeholder="Username" name="username" value="${usernameSignUp}"/>
                                        <br/>
                                        <label>Password<span>*</span></label>
                                        <input type="password" placeholder="Password" name="password" />
                                        <br/>
                                        <label>Address<span>*</span></label>
                                        <input type="text" placeholder="Address" name="address" value="${addressSignUp}"/>
                                        <br/>
                            ...
                            <div class="single-register">
                                ...
                                <button type="submit" form="signUpForm" style="width: 100%">Register</button>
                            </div>
                        </div>
                    </div>
                </div>
