<%-- 
    Document   : home.jsp
    Created on : Feb 25, 2024, 10:15:58 PM
    Author     : hatro
--%>
                            ...
                            <div class="shop-left">
                                ...
                                <div class="left-menu mb-30">
                                    ...
                                    <c:forEach items="${listCategory}" var="cate">
                                        <li><a href="home?search=category&categoryId=${cate.getId()}">${cate.getName()}<span>(6)</span></a></li>
                                        </c:forEach>
                                </ul>
                            </div>
                            <div class="left-title mb-20">
                                            ...
                                            <div class="product-wrapper mb-40">
                                                <div class="product-img">
                                                    <a href="product-details?id=${p.getId()}">
                                                        <img src="${p.getImage()}" alt="book" class="primary" />
                                                    </a>
